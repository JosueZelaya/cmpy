    ...
    public void create(Puesto puesto) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Empleado empleadoListEmpleado : puesto.getEmpleadoList()) {
                Puesto oldFkPuestoOfEmpleadoListEmpleado = empleadoListEmpleado.getFkPuesto();
                empleadoListEmpleado.setFkPuesto(puesto);
                empleadoListEmpleado = em.merge(empleadoListEmpleado);
                if (oldFkPuestoOfEmpleadoListEmpleado != null) {
                    oldFkPuestoOfEmpleadoListEmpleado.getEmpleadoList().remove(empleadoListEmpleado);
                    oldFkPuestoOfEmpleadoListEmpleado = em.merge(oldFkPuestoOfEmpleadoListEmpleado);
                }
            }
            utx.commit();
        } catch (Exception ex) {
        ...
        try {
            ...
            for (Empleado empleadoListOldEmpleado : empleadoListOld) {
                if (!empleadoListNew.contains(empleadoListOldEmpleado)) {
                    empleadoListOldEmpleado.setFkPuesto(null);
                    empleadoListOldEmpleado = em.merge(empleadoListOldEmpleado);
                }
            }
            for (Empleado empleadoListNewEmpleado : empleadoListNew) {
                if (!empleadoListOld.contains(empleadoListNewEmpleado)) {
                    Puesto oldFkPuestoOfEmpleadoListNewEmpleado = empleadoListNewEmpleado.getFkPuesto();
                    empleadoListNewEmpleado.setFkPuesto(puesto);
                    empleadoListNewEmpleado = em.merge(empleadoListNewEmpleado);
                    if (oldFkPuestoOfEmpleadoListNewEmpleado != null && !oldFkPuestoOfEmpleadoListNewEmpleado.equals(puesto)) {
                        oldFkPuestoOfEmpleadoListNewEmpleado.getEmpleadoList().remove(empleadoListNewEmpleado);
                        oldFkPuestoOfEmpleadoListNewEmpleado = em.merge(oldFkPuestoOfEmpleadoListNewEmpleado);
                    }
                }
            }
            utx.commit();
    ...
    public void destroy(Long id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Empleado empleadoListEmpleado : empleadoList) {
                empleadoListEmpleado.setFkPuesto(null);
                empleadoListEmpleado = em.merge(empleadoListEmpleado);
            }
            em.remove(puesto);
            utx.commit();
